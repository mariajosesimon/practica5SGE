...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2021 a las 14:50:53
...
DROP TABLE IF EXISTS `facturacomprasproductos`;
CREATE TABLE IF NOT EXISTS `facturacomprasproductos` (
  `idFactura` int(11) NOT NULL,
  `idProducto` int(11) NOT NULL,
  `Cantidad` int(11) NOT NULL,
  `idConcepto` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idConcepto`),
  KEY `FK_idf_fac` (`idFactura`),
  KEY `FK_idp_pro` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `facturascompras` (
  ...
  KEY `FK_fco_id` (`idComprador`),
  KEY `FK_fco_pro` (`idProveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ordenproduccion` (
  ...
  PRIMARY KEY (`idOrden`),
  KEY `FK_opr_id` (`idProductor`),
  KEY `FK_pfi_idp` (`idProductoFinal`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `presupuestoscompras`;
CREATE TABLE IF NOT EXISTS `presupuestoscompras` (
  `idPresupuesto` int(11) NOT NULL AUTO_INCREMENT,
  `idProveedor` int(11) NOT NULL,
  `FechaPresupuesto` date NOT NULL,
  `idComprador` int(11) NOT NULL,
  PRIMARY KEY (`idPresupuesto`) USING BTREE,
  KEY `FK_pco_idU` (`idComprador`),
  KEY `FK_pco_pro` (`idProveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `presupuestoscomprasproductos`;
CREATE TABLE IF NOT EXISTS `presupuestoscomprasproductos` (
  `idPresupuesto` int(11) NOT NULL,
  `idProducto` int(11) NOT NULL,
  `Cantidad` int(11) NOT NULL,
  `idConcepto` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idConcepto`),
  KEY `FK_idp_pre` (`idPresupuesto`),
  KEY `FK_idp_prd` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `presupuestosventas`;
CREATE TABLE IF NOT EXISTS `presupuestosventas` (
  `idPresupuesto` int(11) NOT NULL AUTO_INCREMENT,
  `idCliente` int(11) NOT NULL,
  `FechaPresupuesto` date NOT NULL,
  `idVendedor` int(11) NOT NULL,
  PRIMARY KEY (`idPresupuesto`),
  KEY `FK_pve_idU` (`idVendedor`),
  KEY `FK_pve_pro` (`idCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `presupuestosventasproductos`;
CREATE TABLE IF NOT EXISTS `presupuestosventasproductos` (
  `idPresupuesto` int(11) NOT NULL,
  `idProducto` int(11) NOT NULL,
  `Cantidad` int(11) NOT NULL,
  `idPVP` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idPVP`),
  KEY `FK_pvp_prd` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `productoscreados`;
CREATE TABLE IF NOT EXISTS `productoscreados` (
  `idProducto` int(11) NOT NULL AUTO_INCREMENT,
  `NombreProducto` varchar(100) NOT NULL,
  `Precio` double NOT NULL,
...
DROP TABLE IF EXISTS `productosutilizadosproduccion`;
CREATE TABLE IF NOT EXISTS `productosutilizadosproduccion` (
  `idProductosUtilizadosOrden` int(11) NOT NULL AUTO_INCREMENT,
  `idOrden` int(11) NOT NULL,
  `idProductoUtilizado` int(11) NOT NULL,
  `Cantidad` int(11) NOT NULL,
  PRIMARY KEY (`idProductosUtilizadosOrden`),
  KEY `FK_pup_idO` (`idOrden`),
  KEY `FK_pup_iPU` (`idProductoUtilizado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `facturasventas` (
  `idFactura` int(11) NOT NULL AUTO_INCREMENT,
  `nFactura` int(11) NOT NULL,
  `idCliente`` int(11) NOT NULL,
  `FechaFactura` date NOT NULL,
...
ALTER TABLE `facturasventas`
  ...
  CREATE TABLE IF NOT EXISTS `facturaventasproductos` (
  `idFactura` int(11) NOT NULL,
  `idProducto` int(11) NOT NULL,
  `Cantidad` int(11) NOT NULL,
  `idConcepto` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idConcepto`),
  ADD CONSTRAINT `FK_fvp_id` FOREIGN KEY (`idFactura`) REFERENCES `facturasventas`` (`idFactura`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_fvp_prd` FOREIGN KEY (`idProducto`) REFERENCES `productoscreados` (`idProducto`) ON DELETE CASCADE ON UPDATE CASCADE
